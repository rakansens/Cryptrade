  ...
  describe('Enhanced Line Analysis Tool', () => {
    describe('execute', () => {
      ...
      it('should filter analysis by type', async () => {
        ...
        const horizontalResult = await enhancedLineAnalysisTool.execute!({ 
          context: horizontalOnlyContext,
          runtimeContext: {} as any
        });
        const trendlinesResult = await enhancedLineAnalysisTool.execute!({ 
          context: trendlinesOnlyContext,
          runtimeContext: {} as any
        });
