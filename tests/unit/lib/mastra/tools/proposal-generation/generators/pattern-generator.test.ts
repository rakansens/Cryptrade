...
import { PatternGenerator } from '@/lib/mastra/tools/proposal-generation/generators/pattern-generator';
import type { PriceData as CandlestickData } from '@/types/market';
import type { GeneratorParams, DetectedPattern } from '@/lib/mastra/tools/proposal-generation/types';
import { ProposalStatus, ProposalType } from '@/types/proposals';
import type { DrawingProposal } from '@/types/proposals';
import { ANALYSIS_PARAMS, COLOR_PALETTE } from '@/lib/mastra/tools/proposal-generation/utils/constants';
import { generateProposalId, calculateStandardDeviation } from '@/lib/mastra/tools/proposal-generation/utils/helpers';
import { detectCandlePatterns } from '@/lib/mastra/tools/proposal-generation/analyzers/market-analyzer';
...
jest.mock('@/lib/mastra/tools/proposal-generation/validators/drawing-validator', () => ({
  validateDrawingData: jest.fn((data) => data),
}));

jest.mock('@/lib/mastra/tools/proposal-generation/utils/helpers', () => ({
